...
This example is used in the readme and commentary.
      ...
      (let ((org-agenda-files (list "~/src/org-super-agenda/test.org"))
            ...
            (org-super-agenda-groups
             '(;; Each group has an implicit boolean OR operator between its selectors.
               ...
               (:order-multi (12 (:name "Shopping in town"
               ...
               (:todo "WAITING" :order 97) ; Set order of this section
...
** Non-agenda agenda commands

This terminology starts getting confusing, but what else to call these items that produce a view using the Org agenda code but is not actually a daily/weekly agenda view?
